...
| Run without an open task | bounded headless Codex runner | lock, JSONL log, final result, exit status | CI or manual run | installing persistent execution or write authority |
