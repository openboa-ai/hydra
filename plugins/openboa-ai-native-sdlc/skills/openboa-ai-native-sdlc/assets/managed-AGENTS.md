...
- Treat agents as responsible work leads inside delegated boundaries. Continue routine, reversible research, planning, implementation, verification, recovery, and bounded automation without waiting for ceremonial approval.
...
- Discover capabilities before choosing a method. For automation, declare the target, wakeup, authority, lock, timeout, expiry, evidence, notification, and rollback; default to read-only and do not install persistent jobs without an exact gate.
